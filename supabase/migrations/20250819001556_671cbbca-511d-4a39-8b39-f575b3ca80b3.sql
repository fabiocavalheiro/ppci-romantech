...
-- Criar enum para status do equipamento (se não existir)
DO $$ BEGIN
    CREATE TYPE equipment_status AS ENUM ('em_dia', 'a_vencer', 'vencido');
EXCEPTION
...
CREATE TABLE public.extintores (
    ...
    status equipment_status NOT NULL DEFAULT 'em_dia',
